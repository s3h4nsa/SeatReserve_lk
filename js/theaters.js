 ...
 * - Mobile menu toggle
 * - Theater filtering (future implementation)
 */
    ...
    theaters.forEach((theater) => {
      ...
      theaterCard.innerHTML = `
                <div class="theater-image">
                    <img src="${theater.image || "/placeholder.svg?height=200&width=300"}" alt="${theater.name}" onerror="this.src='/placeholder.svg?height=200&width=300'">
